  ...
  return (
    <div className='mt-20'>
      <div className='flex justify-around '>
           ...
           <p className='font-sm'>Dive into a world where artificial intelligence transforms the way you interact with technology. Experience seamless automation, personalized recommendations, and cutting-edge solutions tailored just for you.</p>
         <Link to='/chat'>
         <div className='flex '>
      ...
      <div className='flex justify-around mt-20 '>
           ...
           <p className='font-sm'>Discover how our innovative AI technology enhances your daily tasks and decision-making. Embrace efficiency, creativity, and unparalleled insights that empower you to achieve more than ever before!</p>
